...
const SignUp = () => {
  ...
  const [confirmPasswordLabel, setConfirmPasswordLabel] = useState<
    undefined | "flex" | "none"
  >("none");
  const [refCodeLabel, setRefCodeLabel] = useState<undefined | "flex" | "none">(
    "none"
  );
  ...
  const [refCodePlaceholder, setRefCodePlaceholder] = useState(
                    ...
                    <View>
                      ...
                      <View className="mb-6">
                        <InputBox
                          ...
                          displayFloatingLabel={fullnameLabel}
                          placeholder={fullnamePlaceholder}
                          onBlur={() => {
                            setFullnameLabel("none");
                            setFullnamePlaceholder("Fullname");
                          }}
                          onFocus={() => {
                            setFullnameLabel("flex");
                          ...
                          boxBorderColor={errors.fullname ? colors.alerts.error : colors.gray[400]}
                      ...
                      <View className="mb-6">
                        <InputBox
                          ...
                          value={values.email}
                          boxBorderColor={errors.email ? colors.alerts.error : colors.gray[400]}
                      ...
                      <View className="mb-6">
                        <InputBox
                          ...
                          boxHeight={"16"}
                          keyboardType={"default"}
                          displayFloatingLabel={refCodeLabel}
                          placeholder={refCodePlaceholder}
                          onBlur={() => {
                            setRefCodeLabel("none");
                            setRefCodePlaceholder("Referral Code (optional)");
                          }}
                          onFocus={() => {
                            setRefCodeLabel("flex");
                            setRefCodePlaceholder("");
                          }}
                          ...
                          boxBorderColor={errors.referral ? colors.alerts.error : colors.gray[400]}
